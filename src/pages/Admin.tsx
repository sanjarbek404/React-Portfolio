  ...
  return (
    ...
    >
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 mb-2">
        <div>
          <h2 className="text-2xl md:text-3xl font-black tracking-tight text-[#1d1d1f] dark:text-white">Workspace</h2>
          <p className="text-gray-500 mt-1.5 font-medium">Boshqaruv markaziy oynasi va statistika</p>
        </div>
        <Link 
          to="/"
          target="_blank"
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        ...
        >
          <div className="absolute -right-6 -top-6 text-blue-500/5 dark:text-blue-500/10 group-hover:scale-110 transition-transform duration-500"><Eye size={120} /></div>
          ...
          <p className="text-gray-500 dark:text-gray-400 font-semibold relative z-10 mb-2">Ko'rishlar</p>
        ...
        >
          <div className="absolute -right-6 -top-6 text-purple-500/5 dark:text-purple-500/10 group-hover:scale-110 transition-transform duration-500"><Users size={120} /></div>
          <div className="flex justify-between items-start mb-4 relative z-10">
          ...
          <p className="text-gray-500 dark:text-gray-400 font-semibold relative z-10 mb-2">Tashrifchilar</p>
          <div className="flex items-baseline gap-4 relative z-10">
        ...
        >
          ...
          <p className="text-blue-50 font-medium relative z-10 mb-1">Jami Loyihalar</p>
        ...
        >
          ...
          <p className="text-purple-50 font-medium relative z-10 mb-1">Xabarlar</p>
          <div className="relative z-10">
          ...
          {loading ? (
            ...
            <ResponsiveContainer width="100%" height={400}>
              <AreaChart data={stats} margin={{ top: 10, right: 10, left: -20, bottom: 0 }}>
                ...
                <Tooltip 
                  contentStyle={{ borderRadius: '16px', border: '1px solid rgba(0,0,0,0.05)', boxShadow: '0 10px 30px rgba(0,0,0,0.1)', backgroundColor: 'rgba(255, 255, 255, 0.95)', backdropFilter: 'blur(10px)', color: '#1d1d1f', fontWeight: 600 }}
