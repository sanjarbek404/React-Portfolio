        ...
        >
          ...
          >
            ...
            <div className="flex gap-3 justify-end">
              <button
                onClick={onClose}
                className="px-5 py-2.5 rounded-xl font-medium text-gray-600 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-white/10 transition-colors"
              >
                Bekor qilish
              </button>
              <button
                ...
                className="px-5 py-2.5 rounded-xl font-medium bg-red-500 text-white hover:bg-red-600 transition-colors shadow-sm shadow-red-500/20"
              >
                O'chirish
              </button>
            </div>
      ...
      (snapshot) => {
        ...
        const data = snapshot.docs
          .map((doc) => {
            ...
            const name = dateObj.toLocaleDateString("uz-UZ", {
              day: "numeric",
              month: "short",
            });
  ...
  return (
    ...
    >
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 mb-2">
        <div>
          <h2 className="text-2xl md:text-3xl font-black tracking-tight text-[#1d1d1f] dark:text-white">
            Workspace
          </h2>
          <p className="text-gray-500 mt-1.5 font-medium">
            Boshqaruv markaziy oynasi va statistika
          </p>
        </div>
        <Link
          to="/"
          target="_blank"
          className="flex items-center gap-2 px-6 py-2.5 bg-gradient-to-r from-blue-600 to-purple-600 hover:from-blue-700 hover:to-purple-700 text-white rounded-xl font-bold transition-all shadow-md shadow-blue-500/20"
        >
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        <motion.div
          ...
          className="bg-white dark:bg-[#0a0a0a] p-6 rounded-3xl shadow-sm border border-gray-100 dark:border-white/5 relative overflow-hidden group hover:border-blue-500/30 transition-colors"
        >
          <div className="absolute -right-6 -top-6 text-blue-500/5 dark:text-blue-500/10 group-hover:scale-110 transition-transform duration-500">
            <Eye size={120} />
          </div>
          <div className="flex justify-between items-start mb-4 relative z-10">
            ...
            <div className="px-3 py-1 bg-gray-50 dark:bg-white/5 rounded-lg text-xs font-semibold text-gray-500 flex items-center gap-1 cursor-pointer">
              Umumiy
            </div>
          </div>
          <p className="text-gray-500 dark:text-gray-400 font-semibold relative z-10 mb-2">
            Ko'rishlar
          </p>
          <div className="flex items-baseline gap-4 relative z-10">
            <h3 className="text-4xl font-black text-[#1d1d1f] dark:text-white">
              {totals.views}
            </h3>
          </div>
        </motion.div>
        ...
        <motion.div
          ...
          className="bg-white dark:bg-[#0a0a0a] p-6 rounded-3xl shadow-sm border border-gray-100 dark:border-white/5 relative overflow-hidden group hover:border-purple-500/30 transition-colors"
        >
          <div className="absolute -right-6 -top-6 text-purple-500/5 dark:text-purple-500/10 group-hover:scale-110 transition-transform duration-500">
            <Users size={120} />
          </div>
          <div className="flex justify-between items-start mb-4 relative z-10">
        ...
        <motion.div
          ...
          className="bg-gradient-to-br from-blue-600 to-cyan-500 p-6 rounded-3xl text-white shadow-lg shadow-blue-500/20 relative overflow-hidden group"
        >
          ...
          <p className="text-blue-50 font-medium relative z-10 mb-1">
            Jami Loyihalar
          </p>
          <div className="relative z-10">
            <h3 className="text-4xl font-black">{projectsCount}</h3>
          </div>
        </motion.div>
        ...
        <motion.div
          ...
          className="bg-gradient-to-br from-purple-600 to-pink-500 p-6 rounded-3xl text-white shadow-lg shadow-purple-500/20 relative overflow-hidden group"
        >
          <div className="absolute -right-4 -top-4 text-white/10 group-hover:scale-110 transition-transform duration-500">
          ...
          <p className="text-purple-50 font-medium relative z-10 mb-1">
            Xabarlar
          </p>
          <div className="relative z-10">
            <h3 className="text-4xl font-black">{messagesCount}</h3>
          </div>
        </motion.div>
      </div>
      ...
      <motion.div
        ...
        className="bg-white dark:bg-[#0a0a0a] p-6 md:p-8 rounded-3xl shadow-sm border border-gray-100 dark:border-white/5"
      >
        <div className="flex justify-between items-center mb-8">
          <h3 className="text-xl font-bold text-[#1d1d1f] dark:text-white flex items-center gap-2">
            <BarChart3 className="text-blue-500" /> Tashriflar statistikasi
          </h3>
          <div className="px-4 py-2 bg-gray-50 dark:bg-white/5 rounded-xl text-sm font-semibold text-gray-500 flex items-center gap-2 cursor-pointer hover:bg-gray-100 dark:hover:bg-white/10 transition-colors">
            Oxirgi 7 kun <ChevronDown size={14} />
          </div>
        </div>
...
const AdminHeader = ({
  ...
  isAdding,
  onToggleAdd,
  addText = "Yangi qo'shish",
  icon: Icon,
}: any) => (
  <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 mb-2">
    <div>
      <h2 className="text-2xl md:text-3xl font-black tracking-tight text-[#1d1d1f] dark:text-white bg-clip-text text-transparent bg-gradient-to-r from-blue-600 to-purple-600 drop-shadow-sm">
        {title}
      </h2>
      {subtitle && (
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const toastId = toast.loading(
        editingId ? "Loyiha yangilanmoqda..." : "Loyiha saqlanmoqda...",
      );
        ...
        {isAdding && (
          ...
          >
            <div className="bg-white dark:bg-[#0a0a0a] p-8 rounded-2xl shadow-sm border border-gray-100 dark:border-white/5 mb-8">
              ...
              >
                <div>
                  <label className="block text-sm font-bold text-[#1d1d1f] dark:text-gray-300 mb-2 uppercase tracking-wider">
                    Sarlavha
                  </label>
                  <input
                    required
                    ...
                    {formData.image ? (
                      ...
                      <div className="flex flex-col items-center justify-center py-4">
                        <div className="w-20 h-20 bg-blue-50 dark:bg-blue-500/20 text-blue-500 rounded-3xl flex items-center justify-center mb-6">
                          {isUploading ? (
                            <UploadCloud className="animate-bounce" size={40} />
                          ) : (
                            <ImageIcon size={40} />
                          )}
                        </div>
            ...
            >
              ...
              <div className="p-8">
                <div className="flex justify-between items-center mb-4">
                  <span className="text-xs font-black uppercase tracking-widest text-blue-600 dark:text-blue-400 block bg-blue-50 dark:bg-blue-500/10 px-3 py-1 rounded-full">
                    {project.tag}
                  </span>
                  {project.githubUrl && (
                    <Github
                      size={20}
                      className="text-gray-400 hover:text-[#1d1d1f] dark:hover:text-white transition-colors"
                    />
                  )}
                </div>
              ...
              >
                ...
                <div className="md:col-span-2">
                  ...
                  <textarea
                    ...
                    className="w-full bg-gray-50 dark:bg-white/5 border border-gray-200 dark:border-white/10 rounded-xl py-4 px-5 focus:outline-none focus:ring-2 focus:ring-blue-500 text-[#1d1d1f] dark:text-white font-medium"
                    rows={3}
                    placeholder="Nimalar qildingiz..."
                  ></textarea>
                </div>
                <div className="md:col-span-2">
                  <button
                    type="submit"
                    className="bg-blue-600 text-white px-8 py-4 rounded-xl font-bold hover:bg-blue-700 transition-colors w-full md:w-auto shadow-lg shadow-blue-500/30"
                  >
      ...
      <div className="bg-white dark:bg-[#0a0a0a] p-8 rounded-2xl shadow-sm border border-gray-100 dark:border-white/5">
        <div className="space-y-4">
          {experiences.map((exp, index) => (
            ...
            >
              <div>
                <p className="text-xl font-bold text-[#1d1d1f] dark:text-white mb-1">
                  {exp.role}{" "}
                  <span className="text-blue-600 dark:text-blue-400 ml-2 text-base font-medium bg-blue-50 dark:bg-blue-500/10 px-3 py-1 rounded-full">
                    {exp.year}
                  </span>
                </p>
              ...
              >
                ...
                <div className="md:col-span-2">
                  ...
                  <textarea
                    ...
                    className="w-full bg-gray-50 dark:bg-white/5 border border-gray-200 dark:border-white/10 rounded-xl py-4 px-5 focus:outline-none focus:ring-2 focus:ring-blue-500 text-[#1d1d1f] dark:text-white font-medium"
                    rows={3}
                    placeholder="Nimalar o'rgandingiz..."
                  ></textarea>
                </div>
                <div className="md:col-span-2">
                  <button
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const data = {
        ...
        iconUrl:
          formData.iconUrl ||
          `https://cdn.simpleicons.org/${formData.name.toLowerCase().replace(/\s+/g, "")}`,
      };
      if (editingId) {
        ...
        {isAdding && (
          ...
          >
            <div className="bg-white dark:bg-[#0a0a0a] p-8 rounded-2xl shadow-sm border border-gray-100 dark:border-white/5 mb-8">
              ...
              {!editingId && (
                <div className="mb-8">
                  <label className="block text-sm font-bold text-[#1d1d1f] dark:text-gray-300 mb-3 uppercase tracking-wider">
                    Tezkor tanlash (Tayyor iconlar)
                  </label>
                      ...
                      <button
                        ...
                        onClick={() =>
                          setFormData({
                            ...formData,
                            name: preset.name,
                            iconUrl: `https://cdn.simpleicons.org/${preset.slug}/000000`,
                          })
                        }
              ...
              <form onSubmit={handleSubmit} className="flex flex-col gap-6">
                <div className="flex flex-col md:flex-row gap-6">
                  ...
                  <div className="flex-1 w-full">
                    ...
                    <input
                      ...
                      className="w-full bg-gray-50 dark:bg-white/5 border border-gray-200 dark:border-white/10 rounded-xl py-4 px-5 focus:outline-none focus:ring-2 focus:ring-blue-500 text-[#1d1d1f] dark:text-white font-medium"
                      placeholder="https://... (SVG yoki Png)"
                    />
                  </div>
                ...
                <div className="flex justify-end">
                  <button
                    type="submit"
                    className="bg-blue-600 text-white px-8 py-4 rounded-xl font-bold hover:bg-blue-700 transition-colors w-full md:w-auto min-w-[200px] shadow-lg shadow-blue-500/30"
                  >
            ...
            >
              <div className="flex-1">
                <div className="flex justify-between items-center mb-2">
                  <p className="font-bold text-[#1d1d1f] dark:text-white text-lg">
                    {s.name}
                  </p>
                  <span className="text-sm font-bold text-blue-600 dark:text-blue-400 bg-blue-50 dark:bg-blue-500/10 px-2 py-1 rounded-lg">
                    {s.level}%
                  </span>
                </div>
...
const CertificatesManager = () => {
  ...
  const uploadImageToImgBB = async (file: File) => {
    ...
    const res = await fetch(
      `https://api.imgbb.com/1/upload?key=${import.meta.env.VITE_IMGBB_API_KEY || "6d2abda26cb682c3f851da8181ad3ea2"}`,
      {
        method: "POST",
        body: formData,
      },
                ...
                <div>
                  ...
                  {c.link && (
                    <a
                      ...
                      target="_blank"
                      rel="noreferrer"
                      className="text-blue-600 dark:text-blue-400 text-xs font-bold uppercase tracking-wider mt-2 inline-block hover:underline"
                    >
              ...
              >
                ...
                <div>
                  ...
                  >
                    ...
                    <option value="MonitorSmartphone">
                      Monitor & Smartphone
                    </option>
                ...
                <div className="md:col-span-2">
                  ...
                  <textarea
                    ...
                    className="w-full bg-gray-50 dark:bg-white/5 border border-gray-200 dark:border-white/10 rounded-xl py-4 px-5 focus:outline-none focus:ring-2 focus:ring-blue-500 text-[#1d1d1f] dark:text-white font-medium"
                    rows={3}
                    placeholder="Xizmat haqida ma'lumot..."
                  ></textarea>
                </div>
                <div className="md:col-span-2">
                  <button
      ...
      <div className="bg-white dark:bg-[#0a0a0a] p-8 rounded-2xl shadow-sm border border-gray-100 dark:border-white/5">
        <div className="flex items-center gap-4 mb-8">
          ...
          <div>
            ...
            <p className="text-sm text-gray-500 dark:text-gray-400 font-medium">
              Bosh sahifadagi asosiy rasm (ixtiyoriy)
            </p>
          </div>
        </div>
        ...
        <div className="mb-8 max-w-2xl">
          <label className="block text-sm font-bold text-[#1d1d1f] dark:text-gray-300 mb-2 uppercase tracking-wider">
            Rasm URL manzili (Link yoki /public papkadan)
          </label>
          <input
            type="text"
            value={heroImage}
          ...
          <p className="text-sm text-gray-500 mt-2">
            Siz to'g'ridan-to'g'ri rasm linkini kiritishingiz yoki public
            papkadagi rasm nomini (masalan: /me.jpg) yozishingiz mumkin.
          </p>
        </div>
        ...
        <div className="border-t border-gray-100 dark:border-white/10 pt-12">
          <h3 className="text-2xl font-bold text-[#1d1d1f] dark:text-white mb-8">
            Men haqimda (BentoGrid)
          </h3>
          <form className="grid grid-cols-1 md:grid-cols-2 gap-6 max-w-5xl mb-12">
            <div className="md:col-span-2">
              ...
              <input
                type="text"
                value={socials.aboutTitle}
                onChange={(e) =>
                  setSocials({ ...socials, aboutTitle: e.target.value })
                }
                className="w-full bg-gray-50 dark:bg-white/5 border border-gray-200 dark:border-white/10 rounded-xl py-4 px-5 focus:outline-none focus:ring-2 focus:ring-blue-500 text-[#1d1d1f] dark:text-white font-medium"
                placeholder="Sodda. Kreativ. Samarali."
              />
            </div>
            <div className="md:col-span-2">
              <label className="block text-sm font-bold text-[#1d1d1f] dark:text-gray-300 mb-2 uppercase tracking-wider">
              ...
              <textarea
                value={socials.aboutShort}
                onChange={(e) =>
                  setSocials({ ...socials, aboutShort: e.target.value })
                }
                rows={2}
                className="w-full bg-gray-50 dark:bg-white/5 border border-gray-200 dark:border-white/10 rounded-xl py-4 px-5 focus:outline-none focus:ring-2 focus:ring-blue-500 text-[#1d1d1f] dark:text-white font-medium"
            ...
            <div className="md:col-span-2">
              ...
              <textarea
                value={socials.aboutFull}
                onChange={(e) =>
                  setSocials({ ...socials, aboutFull: e.target.value })
                }
                rows={5}
                className="w-full bg-gray-50 dark:bg-white/5 border border-gray-200 dark:border-white/10 rounded-xl py-4 px-5 focus:outline-none focus:ring-2 focus:ring-blue-500 text-[#1d1d1f] dark:text-white font-medium"
            ...
            <div>
              ...
              <input
                type="text"
                value={socials.expYears}
                onChange={(e) =>
                  setSocials({ ...socials, expYears: e.target.value })
                }
                className="w-full bg-gray-50 dark:bg-white/5 border border-gray-200 dark:border-white/10 rounded-xl py-4 px-5 focus:outline-none focus:ring-2 focus:ring-blue-500 text-[#1d1d1f] dark:text-white font-medium"
                placeholder="1+"
              />
          ...
          <form className="grid grid-cols-1 md:grid-cols-2 gap-6 max-w-5xl mb-12">
            <div>
              ...
              <input
                type="text"
                value={socials.githubCommits}
                onChange={(e) =>
                  setSocials({ ...socials, githubCommits: e.target.value })
                }
                className="w-full bg-gray-50 dark:bg-white/5 border border-gray-200 dark:border-white/10 rounded-xl py-4 px-5 focus:outline-none focus:ring-2 focus:ring-blue-500 text-[#1d1d1f] dark:text-white font-medium"
                placeholder="1.2k"
              />
            ...
            <div>
              ...
              <input
                type="text"
                value={socials.githubYearText}
                onChange={(e) =>
                  setSocials({ ...socials, githubYearText: e.target.value })
                }
                className="w-full bg-gray-50 dark:bg-white/5 border border-gray-200 dark:border-white/10 rounded-xl py-4 px-5 focus:outline-none focus:ring-2 focus:ring-blue-500 text-[#1d1d1f] dark:text-white font-medium"
                placeholder="Bu yilgi faollik"
              />
            </div>
            <div>
              <label className="block text-sm font-bold text-[#1d1d1f] dark:text-gray-300 mb-2 uppercase tracking-wider">
              ...
              <input
                type="text"
                value={socials.spotifySong}
                onChange={(e) =>
                  setSocials({ ...socials, spotifySong: e.target.value })
                }
                className="w-full bg-gray-50 dark:bg-white/5 border border-gray-200 dark:border-white/10 rounded-xl py-4 px-5 focus:outline-none focus:ring-2 focus:ring-blue-500 text-[#1d1d1f] dark:text-white font-medium"
            ...
            <div>
              ...
              <input
                type="text"
                value={socials.spotifyArtist}
                onChange={(e) =>
                  setSocials({ ...socials, spotifyArtist: e.target.value })
                }
                className="w-full bg-gray-50 dark:bg-white/5 border border-gray-200 dark:border-white/10 rounded-xl py-4 px-5 focus:outline-none focus:ring-2 focus:ring-blue-500 text-[#1d1d1f] dark:text-white font-medium"
                placeholder="ChilledCow"
              />
            </div>
          </form>
          ...
          >
            <div>
              ...
              <input
                ...
                className="w-full bg-gray-50 dark:bg-white/5 border border-gray-200 dark:border-white/10 rounded-xl py-4 px-5 focus:outline-none focus:ring-2 focus:ring-blue-500 text-[#1d1d1f] dark:text-white font-medium"
                placeholder="hello@misol.uz"
              />
            </div>
            <div>
              <label className="block text-sm font-bold text-[#1d1d1f] dark:text-gray-300 mb-2 uppercase tracking-wider">
                Rezyume Linki (URL yoki Fayl)
              </label>
              <p className="text-xs text-gray-500 mb-3">
                Rezyumeni ikki xil usulda qo'shishingiz mumkin:
                <br />
                1. <b>Link orqali:</b> Google Drive yoki boshqa joydagi to'liq
                linkni kiriting (masalan, <code>https://...</code>)<br />
                2. <b>Fayl orqali:</b> Rezyume faylini (masalan,{" "}
                <code>resume.pdf</code>) loyihaning <code>public</code>{" "}
                papkasiga yuklang va bu yerga <code>/resume.pdf</code> deb
                yozing.
              </p>
              <div className="flex items-center gap-4">
                <input
            ...
            <div className="md:col-span-2 mt-4">
              <button
                ...
                className="bg-blue-600 text-white px-10 py-4 rounded-xl font-bold hover:bg-blue-700 transition-colors disabled:opacity-50 shadow-lg shadow-blue-500/30 w-full md:w-auto"
              >
...
const MessagesManager = () => {
  ...
  return (
    <motion.div
      ...
      className="space-y-8"
    >
      <AdminHeader title="Xabarlar" subtitle="Portfoliodan kelgan xabarlar" />
              ...
              >
                <div className="flex-1">
                  <div className="flex items-center gap-4 mb-4">
                    ...
                    <span className="text-xs font-bold text-gray-400 bg-gray-100 dark:bg-white/10 px-3 py-1 rounded-full uppercase tracking-wider">
                      {new Date(msg.createdAt).toLocaleString("uz-UZ")}
                    </span>
                  </div>
                  <a
                    href={`mailto:${msg.email}`}
                    className="text-blue-600 dark:text-blue-400 text-sm font-bold mb-6 inline-block hover:underline"
                  >
                    {msg.email}
                  </a>
                  <p className="text-[#1d1d1f] dark:text-gray-300 bg-gray-50 dark:bg-white/5 p-6 rounded-2xl leading-relaxed">
                    {msg.message}
                  </p>
                </div>
                <DeleteButton
                ...
                <div className="flex-1">
                  <div className="flex items-center gap-4 mb-4">
                    <img
                      ...
                      alt="Avatar"
                      className="w-12 h-12 rounded-full border border-gray-200 dark:border-white/10 shrink-0"
                    />
                    <div>
                      <div className="flex items-center gap-2">
                        ...
                        {msg.githubParams && (
                          <span className="text-[10px] text-gray-500 bg-gray-200 dark:bg-white/10 px-2 py-0.5 rounded-full">
                            @{msg.githubParams}
                          </span>
                        )}
                      </div>
                      <span className="text-xs font-medium text-gray-400 uppercase tracking-wider">
                        {msg.createdAt?.toDate
                          ? msg.createdAt.toDate().toLocaleString("uz-UZ")
                          : ""}
                      </span>
                    </div>
                  </div>
...
const TranslationsManager = () => {
    ...
    const fetchTranslations = async () => {
      try {
        ...
        if (docSnap.exists() && docSnap.data().data) {
          setData(
            typeof docSnap.data().data === "string"
              ? docSnap.data().data
              : JSON.stringify(docSnap.data().data, null, 2),
          );
        } else {
  ...
  const handleSave = async () => {
    ...
    try {
      // Validate JSON
      JSON.parse(data);
      await setDoc(doc(db, "settings", "translations"), {
        data,
    ...
    >
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 mb-2">
        <div>
          ...
          <p className="text-gray-500 mt-1.5 font-medium">
            Barcha tillardagi sayt matnlarini (jumladan Statistikalar) JSON
            shaklida tahrirlang.
          </p>
        </div>
        <button
          onClick={handleSave}
          disabled={saving}
          className="bg-blue-600 hover:bg-blue-700 w-full md:w-auto text-white px-8 py-2.5 rounded-xl font-bold transition-all shadow-md shadow-blue-500/20 flex items-center justify-center"
        >
      ...
      <div className="bg-white dark:bg-[#0a0a0a] rounded-2xl border border-gray-100 dark:border-white/10 p-6">
        <p className="text-sm text-yellow-600 dark:text-yellow-400 mb-4 bg-yellow-50 dark:bg-yellow-900/20 p-4 rounded-xl">
          Eslatma: Mavjud JSON kalitlarini o'zgartirmang, faqat qiymatlarini
          (matnlarni) tahrirlang. Masalan, UZ.nav.about o'rniga boshqa so'z
          yozishingiz mumkin.
        </p>
        <textarea
          value={data}
  ...
  return (
    ...
    >
      <div className="flex items-center justify-between mb-8">
        <div>
          <h2 className="text-3xl font-display font-bold text-[#1d1d1f] dark:text-white mb-2">
            Faol Seanslar
          </h2>
          <p className="text-gray-500">
            Tizimga ulangan barcha qurilmalar reyestri
          </p>
        </div>
      </div>
          ...
          <table className="w-full text-left border-collapse min-w-[700px]">
            <thead>
              <tr className="bg-gray-50 dark:bg-white/5 border-b border-gray-200 dark:border-white/10">
                <th className="p-4 pl-6 text-sm font-semibold text-gray-500 uppercase tracking-wider w-1/3">
                  Qurilma / OS
                </th>
                ...
                <th className="p-4 pr-6 text-sm font-semibold text-gray-500 uppercase tracking-wider text-right">
                  Amal
                </th>
              </tr>
            </thead>
              ...
              {loading ? (
                ...
                sessions.map((session) => (
                  ...
                  >
                    <td className="p-4 pl-6">
                      <div className="flex items-center gap-4">
                        ...
                        <div>
                          ...
                          <div
                            className="text-xs text-gray-500 font-mono mt-1 max-w-[200px] truncate"
                    ...
                    <td className="p-4">
                      <div className="text-[#1d1d1f] dark:text-white font-medium">
                        {session.browser}
                      </div>
                    </td>
                    <td className="p-4">
                      ...
                      {session.loginTime && (
                        <div className="text-xs text-gray-500 mt-1">
                          Kirgan:{" "}
                          {new Date(
                            session.loginTime.seconds * 1000,
    ...
    <div className="min-h-screen bg-[#f4f7fe] dark:bg-[#050505] font-sans selection:bg-blue-500/30">
      ...
      <div className="md:hidden sticky top-0 z-50 bg-white/80 dark:bg-[#0a0a0a]/80 backdrop-blur-xl border-b border-gray-200 dark:border-white/10 px-4 py-4 flex items-center justify-between">
        <Link to="/" className="flex items-center gap-2">
          <div className="w-8 h-8 flex items-center justify-center bg-blue-600 text-white rounded-lg font-black text-lg">
            S
          </div>
        ...
        <button
          ...
          className="p-2 text-gray-500 dark:text-gray-400 bg-gray-100 dark:bg-white/5 rounded-xl"
        >
      ...
      <div className="flex flex-col md:flex-row">
        ...
        {/* Sidebar */}
        <aside
          className={`fixed md:sticky top-0 left-0 h-screen w-[280px] bg-white dark:bg-[#0a0a0a] border-r border-gray-200 text-gray-800 dark:text-white dark:border-white/5 flex flex-col z-50 transition-transform duration-300 ${isMobileMenuOpen ? "translate-x-0" : "-translate-x-full md:translate-x-0"}`}
        >
          <div className="p-8 hidden md:block">
            <Link to="/" className="flex items-center gap-4 group">
              <div className="w-10 h-10 bg-gradient-to-tr from-blue-600 to-purple-600 text-white rounded-xl flex items-center justify-center font-black text-xl shadow-lg shadow-blue-500/30 group-hover:scale-105 transition-transform">
                S
              </div>
              <div>
          ...
          <nav className="flex-1 px-4 space-y-1.5 mt-8 md:mt-2 overflow-y-auto scrollbar-hide">
            <div className="text-xs font-semibold text-gray-400 uppercase tracking-widest px-4 mb-4">
              Menyu
            </div>
            {navItems.map((item, index) => {
              ...
              return (
                ...
                >
                  <span
                    className={`transition-transform duration-300 ${isActive ? "scale-110 text-white" : "group-hover:scale-110"}`}
                  >
                    {item.icon}
                  </span>
        ...
        <main className="flex-1 min-h-screen max-w-[100vw] flex flex-col">
          ...
          <header className="hidden md:flex h-20 items-center justify-between px-8 bg-white/70 dark:bg-[#0a0a0a]/70 backdrop-blur-md border-b border-gray-100 dark:border-white/5 sticky top-0 z-40">
            <div className="flex items-center gap-4">
              <div className="relative">
                <input
                  ...
                  className="pl-10 pr-4 py-2 bg-gray-50 dark:bg-white/5 border border-gray-200 dark:border-white/10 rounded-xl focus:outline-none focus:ring-2 focus:ring-blue-500 text-sm w-64 text-[#1d1d1f] dark:text-white transition-all shadow-sm focus:shadow-md"
                  onKeyDown={(e) => {
                    if (e.key === "Enter")
                      toast("Qidiruv funksiyasi hozircha ulanmagan");
                  }}
                />
            ...
            <div className="flex items-center gap-4">
              <button
                onClick={() => toast("Yangi xabarlar yo'q")}
                className="relative p-2 text-gray-500 hover:bg-gray-100 dark:hover:bg-white/5 rounded-full transition-colors active:scale-95"
              >
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  width="20"
              ...
              <div
                onClick={handleLogout}
                className="flex items-center gap-3 cursor-pointer group px-2 py-1 rounded-xl hover:bg-gray-50 dark:hover:bg-white/5 transition-colors"
              >
                ...
                <div className="hidden lg:block">
                  <p className="text-sm font-semibold text-[#1d1d1f] dark:text-white leading-tight group-hover:text-blue-500 transition-colors">
                    Sanjarbek
                  </p>
