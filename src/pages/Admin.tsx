  ...
  return (
    ...
    >
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 bg-white/50 dark:bg-[#0a0a0a]/50 backdrop-blur-xl p-6 rounded-[2rem] border border-gray-200/50 dark:border-white/5 shadow-sm">
        <div>
          <h2 className="text-3xl font-black tracking-tight text-[#1d1d1f] dark:text-white">
            Dashboard
          </h2>
          <p className="text-gray-500 mt-1 font-medium">
            Saykingizning umumiy statistikasi
          </p>
        </div>
        <Link
          to="/"
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        >
          ...
          <div className="flex flex-col gap-4 relative z-10">
            ...
            <div>
              <p className="text-sm text-gray-500 dark:text-gray-400 font-medium mb-1">
                Faoliyat ko'rsatkichi
              </p>
              <h3 className="text-4xl font-black text-[#1d1d1f] dark:text-white">
                +{(totals.views / (totals.visitors || 1)).toFixed(1)}
              </h3>
            </div>
          </div>
        </motion.div>
      ...
      >
        <h3 className="text-xl font-bold text-[#1d1d1f] dark:text-white mb-8">
          Tashriflar statistikasi (Ijobiy O'sish)
        </h3>
    ...
    >
      ...
      <AnimatePresence>
        {isAdding && (
          ...
          >
            <div className="bg-white dark:bg-[#0a0a0a] p-8 rounded-[2rem] shadow-xl shadow-black/5 border border-white/20 mb-8">
              ...
              >
                ...
                <div className="md:col-span-2">
                  <label className="block text-sm font-bold text-[#1d1d1f] dark:text-gray-300 mb-2 uppercase tracking-wider">
                    Loyiha Fayli (ZIP/RAR) - Hozircha o'chirilgan
                  </label>
                  ...
                  {formData.downloadUrl && (
                    <p className="text-xs text-green-500 mt-2 font-medium truncate">
                      Fayl manzili: {formData.downloadUrl}
                    </p>
                  )}
                </div>
                <div className="md:col-span-2">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-8">
        {loading ? (
          ...
          <div className="col-span-full text-center py-20 bg-white dark:bg-[#0a0a0a] rounded-[2rem] border border-gray-100 dark:border-white/10">
            <FolderKanban
          ...
          projects.map((project, index) => (
            <motion.div
              ...
              className="bg-white dark:bg-[#0a0a0a] rounded-[2rem] overflow-hidden border border-gray-100 dark:border-white/10 shadow-lg shadow-black/5 group transition-transform duration-300"
            >
...
const ExperienceManager = () => {
  ...
  return (
    ...
    >
      ...
      <div className="bg-white dark:bg-[#0a0a0a] p-8 rounded-[2rem] shadow-xl shadow-black/5 border border-white/20">
    ...
    >
      ...
      <div className="grid grid-cols-1 gap-6">
        {loading ? (
          ...
          <div className="text-center py-20 bg-white dark:bg-[#0a0a0a] rounded-[2rem] border border-gray-100 dark:border-white/10">
            <MessageSquare
              className="mx-auto text-gray-300 dark:text-gray-600 mb-6"
              size={64}
            />
          ...
          <AnimatePresence>
            {messages.map((msg, index) => (
              <motion.div
                ...
                transition={{ duration: 0.4, delay: index * 0.1 }}
                className="bg-white dark:bg-[#0a0a0a] p-8 rounded-[2rem] border border-gray-100 dark:border-white/10 shadow-lg shadow-black/5 flex flex-col md:flex-row gap-8 justify-between items-start group hover:-translate-y-1 transition-transform duration-300"
              >
                <div className="flex-1">
    ...
    >
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 bg-white/50 dark:bg-[#0a0a0a]/50 backdrop-blur-xl p-6 rounded-[2rem] border border-gray-200/50 dark:border-white/5 shadow-sm">
        ...
        <button
          onClick={handleSave}
          disabled={saving}
          className="bg-blue-600 hover:bg-blue-700 w-full md:w-auto text-white px-8 py-3 rounded-xl font-bold transition-all shadow-lg flex items-center justify-center"
        >
          {saving ? "Saqlanmoqda..." : "Saqlash"}
        </button>
      </div>

      <div className="bg-white dark:bg-[#0a0a0a] rounded-[2rem] border border-gray-100 dark:border-white/10 p-6">
